...
// Beautiful loading component for the lazy loaded component
    ...
    <div className="text-center">
      ...
      <div className="relative mx-auto mb-8 w-24 h-24">
        <div className="absolute inset-0 bg-gradient-to-t from-blue-600 to-blue-400 rounded-lg shadow-lg animate-pulse">
          ...
          <div
            className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-x-1 w-1 h-1 bg-yellow-400 rounded-full"
            style={{ top: "70%" }}
          ></div>
        </div>
